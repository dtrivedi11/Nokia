...
var DataPairs = (_temp = _class2 = function (_React$Component) {
  ...
  DataPairs.prototype.render = function render() {
    ...
    if (!this.state.showingAll && haveTruncated) {
      ...
      rows.push(React.createElement('dt', { key: 'allData-label' }));
      rows.push(React.createElement(
        'dd',
        { key: 'allData-value' },
        React.createElement(
  ...
  return DataPairs;
}(React.Component), _class2.MAX_CHARACTERS = 100, _temp);
export { DataPairs as default };
