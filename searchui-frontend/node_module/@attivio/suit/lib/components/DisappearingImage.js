...
var DisappearingImage = function (_React$Component) {
  ...
  DisappearingImage.prototype.render = function render() {
    ...
    if (!this.state.error) {
      return _react2.default.createElement('img', _extends({ onError: this.onError }, this.props)); // eslint-disable-line jsx-a11y/alt-text
    }
...
exports.default = DisappearingImage;
