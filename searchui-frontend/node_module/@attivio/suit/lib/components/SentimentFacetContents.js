...
var _SentimentBar = require('./SentimentBar');

var _SentimentBar2 = _interopRequireDefault(_SentimentBar);
...
var SentimentFacetContents = function (_React$Component) {
  ...
  SentimentFacetContents.prototype.handleClick = function handleClick(positive) {
    ...
    if (clickedBucket) {
      ...
      var prettierBucket = new _SearchFacetBucket2.default(clickedBucket.value, label, clickedBucket.count, clickedBucket.filter, clickedBucket.max, clickedBucket.min);
  ...
  SentimentFacetContents.prototype.render = function render() {
    ...
    return _react2.default.createElement(_SentimentBar2.default, {
      posCount: posCount,
      negCount: negCount,
...
exports.default = SentimentFacetContents;
