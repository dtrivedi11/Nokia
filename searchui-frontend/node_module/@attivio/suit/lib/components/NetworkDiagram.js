...
exports.default = exports.Edge = exports.Node = undefined;
...
var Node = exports.Node = function Node(id, label) {
...
var Edge = exports.Edge = function Edge(from, to) {
...
var NetworkDiagram = (_temp = _class3 = function (_React$Component) {
  ...
  NetworkDiagram.prototype.componentDidMount = function componentDidMount() {
    ...
    this.network = new _vis2.default.Network(this.networkDiagram, data, this.props.options);
