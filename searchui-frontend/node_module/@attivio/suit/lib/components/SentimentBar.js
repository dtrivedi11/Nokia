...
var SentimentBar = (_temp = _class = function (_React$Component) {
  ...
  SentimentBar.prototype.render = function render() {
    ...
    var posBar = showPos ? _react2.default.createElement("div", {
    ...
    var negBar = showNeg ? _react2.default.createElement("div", {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        posBar,
        negBar,
        showNeither ? _react2.default.createElement("div", { className: "attivio-sentiment-chart-bar-empty", "aria-hidden": "true", style: { width: '100%' } }) : ''
      )
    );
  };
