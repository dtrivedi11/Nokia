...
var _SignalData = require('./SignalData');

var _SignalData2 = _interopRequireDefault(_SignalData);
...
var SearchDocument = function (_AbstractDocument) {
  ...
  SearchDocument.fromJson = function fromJson(json) {
    ...
    if (json.signal) {
      result.signal = _SignalData2.default.fromJson(json.signal);
    }
    return result;
  };
...
exports.default = SearchDocument;
